...
var RobotDirectives = require("../internal/robot-directives");
...
function excludeLink(link, instance)
{
	...
	const protocol = link.url.parsed && link.url.parsed.protocol ? link.url.parsed.protocol.replace(/:$/, '') : null;
	if (protocol && instance.options.excludedSchemes[protocol] === true) return "BLC_SCHEME";
